namespace SJ.DesktopModules.HB.Class
{
    ...
    public class RESERVE_DEVIATION_REASON : ICacheableClass, IAutoFieldAble
    {
        ...
        public RESERVE_DEVIATION_REASON()
        {
            base..ctor();
            return;
        }
        ...
        public static void DelTrue(int __nID)
        {
            ...
            reserve_deviation_reason.Id = __nID;
            CommonClassDB.Instance(reserve_deviation_reason).delte(reserve_deviation_reason);
        Label_0028:
            return;
        }

        public static RESERVE_DEVIATION_REASON Get(int __nID)
        {
            RESERVE_DEVIATION_REASON reserve_deviation_reason;
            RESERVE_DEVIATION_REASON reserve_deviation_reason2;
            bool flag;
            if (((__nID < 1) == 0) != null)
            {
                goto Label_0010;
            }
            reserve_deviation_reason2 = null;
            goto Label_0037;
        Label_0010:
            reserve_deviation_reason = new RESERVE_DEVIATION_REASON();
            reserve_deviation_reason.Id = __nID;
            reserve_deviation_reason2 = (RESERVE_DEVIATION_REASON) CommonClassDB.Instance(reserve_deviation_reason).get(reserve_deviation_reason, reserve_deviation_reason.Id);
        Label_0037:
            return reserve_deviation_reason2;
        }
        ...
        public Hashtable GetFieldNameHash()
        {
            ...
            if ((File.Exists(string.Format("{0}RESERVE_DEVIATION_REASON.AutoField", strArray[1])) == 0) != null)
            {
                goto Label_0031;
            }
            goto Label_0176;
        ...
        public static int GetNextOrderID()
        {
            ...
            int num;
            bool flag;
            reserve_deviation_reasonArray = List();
            if (((reserve_deviation_reasonArray == null) ? 0 : ((((int) reserve_deviation_reasonArray.Length) < 1) == 0)) != null)
            {
                goto Label_001F;
            }
            num = 1;
            goto Label_0030;
        Label_001F:
            num = reserve_deviation_reasonArray[((int) reserve_deviation_reasonArray.Length) - 1].OrderId + 1;
        Label_0030:
            return num;
        }
        ...
        public static RESERVE_DEVIATION_REASON[] List(string __strFilter, string __strSort, int __nPageIndex, int __nPageSize)
        {
            RESERVE_DEVIATION_REASON reserve_deviation_reason;
            RESERVE_DEVIATION_REASON[] reserve_deviation_reasonArray;
            RESERVE_DEVIATION_REASON[] reserve_deviation_reasonArray2;
            reserve_deviation_reason = new RESERVE_DEVIATION_REASON();
            reserve_deviation_reasonArray = (RESERVE_DEVIATION_REASON[]) CommonClassDB.Instance(reserve_deviation_reason).load(reserve_deviation_reason, __nPageIndex, __nPageSize, __strFilter, __strSort);
            reserve_deviation_reasonArray2 = reserve_deviation_reasonArray;
        Label_0021:
            return reserve_deviation_reasonArray2;
        }
