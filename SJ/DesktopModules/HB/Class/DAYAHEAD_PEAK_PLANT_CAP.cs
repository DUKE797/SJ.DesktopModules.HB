namespace SJ.DesktopModules.HB.Class
{
    ...
    public class DAYAHEAD_PEAK_PLANT_CAP : HB_DAYAPOWER, ICacheableClass, IAutoFieldAble, IChartClass
    {
        public string DBI_ID;
        public string PLANT_NAME;
        public DateTime PRESCHED_DATE;

        public DAYAHEAD_PEAK_PLANT_CAP()
        {
            base..ctor();
            return;
        }
        ...
        public static unsafe void Del(int __nID)
        {
            ...
            dayahead_peak_plant_cap = Get(__nID);
            dayahead_peak_plant_cap.IsDelete = 1;
            dayahead_peak_plant_cap.Deleter = FunUtil.GetCurrentUserID();
            dayahead_peak_plant_cap.DeleteTime = &DateTime.Now.Ticks;
            CommonClassDB.Instance(dayahead_peak_plant_cap).set(dayahead_peak_plant_cap);
        Label_0047:
            return;
        }
        ...
        {
            ArrayList list;
            list = base.GetChartData(__alFields, this.PRESCHED_DATE, "日前调峰能力");
        Label_0016:
            return list;
        }
        ...
        public Hashtable GetFieldNameHash()
        {
            ...
            if ((File.Exists(string.Format("{0}DAYAHEAD_PEAK_PLANT_CAP.AutoField", strArray[1])) == 0) != null)
            {
                goto Label_002E;
            }
            goto Label_0063;
        ...
        public static int GetNextOrderID()
        {
            ...
            int num;
            bool flag;
            dayahead_peak_plant_capArray = List();
            if (((dayahead_peak_plant_capArray == null) ? 0 : ((((int) dayahead_peak_plant_capArray.Length) < 1) == 0)) != null)
            {
                goto Label_001F;
            }
            num = 1;
            goto Label_0030;
        Label_001F:
            num = dayahead_peak_plant_capArray[((int) dayahead_peak_plant_capArray.Length) - 1].OrderId + 1;
        Label_0030:
            return num;
        }
